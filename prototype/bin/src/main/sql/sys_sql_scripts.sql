...
(
	...
	full_name varchar(256) binary NULL COMMENT '全称',
	...
	remarks varchar(256) binary COMMENT '备注信息',
...
(
	...
	title varchar(256) binary DEFAULT '' COMMENT '日志标题',
	create_by varchar(64) binary COMMENT '创建者',
	create_date datetime COMMENT '创建时间',
	remote_addr varchar(256) binary COMMENT '操作IP地址',
	user_agent varchar(256) binary COMMENT '用户代理',
	request_uri varchar(256) binary COMMENT '请求URI',
...
(
	...
	address varchar(256) binary COMMENT '联系地址',
	...
	USEABLE char(1) binary COMMENT '是否启用',
...
(
	...
	enname varchar(256) binary COMMENT '英文名称',
	role_type varchar(256) binary COMMENT '角色类型',
	data_scope char(1) COMMENT '数据范围',
	is_sys char(1) COMMENT '是否系统数据',
	useable char(1) COMMENT '是否可用',
	create_by varchar(64) binary NOT NULL COMMENT '创建者',
	create_date datetime NOT NULL COMMENT '创建时间',
	update_by varchar(64) binary NOT NULL COMMENT '更新者',
	update_date datetime NOT NULL COMMENT '更新时间',
...
(
	id varchar(64) binary NOT NULL COMMENT '编号',
	company_id varchar(64) binary  NULL COMMENT '归属公司',
	office_id varchar(64) binary  COMMENT '归属部门',
